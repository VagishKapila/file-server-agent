...
# ------------------------------------------------------------------
# Upload root (still valid for NON-PDF uploads like drawings, images)
# PDFs generated by reports go to R2 — this stays local by design.
# ------------------------------------------------------------------
...
async def upload_project_files(
    ...
    """
    Upload arbitrary project files (drawings, images, docs).
    These remain LOCAL. PDFs generated by reports go to R2.
    """
    saved = []
    ...
    for file in files:
        ...
        record = ProjectFile(
            ...
            stored_path=str(stored_path),  # LOCAL PATH
